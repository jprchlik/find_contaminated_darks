...
#fit with initial guesses
           ...
           print '{8}{9:1d}=[{0:^10.5f},{3:^10.5f},{2:^15.4e},{1:^10.5f},{4:^10.5f},{5:^20.9e},{6:^20.9e},{7:^10.5f}]'.format(popt[0],popt[1],popt[2],popt[3],popt[4],popt[5],popt[6],popt[7],self.ptype,i+1)
           fig, ax = plt.subplots()
